                        ...
                        <div className="relative max-w-2xl mx-auto">
                            <Reveal>
                                ...
                                <Tween
                                    ...
                                    ease="back.out(1.2)"
                                >
                                    <div className="absolute top-0 block w-48 h-48 left-1/2" style={{ transform: 'translate(50px, -150px)' }}>
                                ...
                                <Tween
                                    ...
                                    ease="back.out(1.2)"
                                >
                                    <div className="absolute bottom-0 right-0 block w-48 h-48" style={{ transform: 'translate(70%, 40%)' }}>
                                ...
                                <Tween
                                    ...
                                    ease="back.out(1.2)"
                                >
                                    <div className="absolute bottom-0 left-0 block w-48 h-48" style={{ transform: 'translate(-90%,70%)' }}>
                                        <div className="absolute inset-0 rounded-lg shadow-image"><Image src="/images/Kyle-Profile.jpg" layout="fill" alt="Kyle" /></div>
                                        <div className="relative w-full h-full overflow-hidden rounded-lg ring-8 ring-indigo-600">
