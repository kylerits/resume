...
const experience = [
        {
            ...
            description: 'Leading projects like bespoke UI kit to match current Ruoff brand and accessibility standards and a loan comparison tool available to hundreds of loan officers, I strive to leave a positive impact on my team and Ruoff as a whole.'
        },
        {
    ...
    return ( 
        <div className="relative py-10 overflow-hidden lg:py-16">
            <div className="container">
                <h2 className="relative text-5xl font-bold text-indigo-700 lg:text-8xl lg:pl-16">Experience</h2>
